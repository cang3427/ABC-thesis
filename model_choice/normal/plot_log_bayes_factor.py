...
if VARIANCE is None:
    benchmarkLogBayesFactors = np.load(os.path.join(DATA_DIR, "mcmc/log_bayes_factors_100000_cp60.npy"))
    benchmarkLabel = "PyMC"
else:
...
for epsilon in EPSILONS:
    ...
    plt.plot(SIZES, benchmarkLogBayesFactors, label = benchmarkLabel, linestyle = "dashed", color = "k")
