...
if __name__ == '__main__':
    ...
    plt.plot(SIZES, exactLogBayesFactors, label = 'Exact', linestyle = 'dashed', color = 'k')
    plt.plot(SIZES, mcmcLogBayesFactors, label = 'PyMC (samples = ' + str(MCMC_SAMPLES) + ')', color = 'g')
    ...
    plt.savefig(os.path.join(SAVE_DIR, "exact_vs_pymc_" + str(MCMC_SAMPLES) + ".png"))
